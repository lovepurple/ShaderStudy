...
////// Emissive:
                float node_2610 = 0.0;
                float node_6113 = (node_2610 + ( (sceneZ - _ProjectionParams.g) * (1.0 - node_2610) ) / (_ProjectionParams.b - _ProjectionParams.g));
                float3 emissive = float3(node_6113,node_6113,node_6113);
